...
knitr::opts_chunk$set(fig.width = 11, collapse = T, comment = "#>", fig.path = "README-", warning = F, message = F)
```

# breaker
This package contains functions to work with different break line options.
